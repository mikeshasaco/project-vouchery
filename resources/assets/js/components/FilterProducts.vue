...
<div class="">
    ...
    <div>
        ...
        <select v-model="filter" class="filter-selecttag">
            ...
            <option value="0-20">Between $0 and $20</option>
            <option value="20-30">Between $20 and $30</option>
            <option value="30-40">Between $30 and $40</option>
            <option value="40-50">Between $40 and $50</option>
            <option value="50-60">Between $50 and $60</option>
            <option value="60-70">Between $60 and $70</option>
            <option value="70-80">Between $70 and $80</option>
            <option value="80-90">Between $80 and $90</option>
            <option value="90-100">Between $90 and $100</option>
