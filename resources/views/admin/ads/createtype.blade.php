...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-9">
                <div class="well">
                  <h2 style="margin-top:85px;">Create Ad Type</h2>

                <form method="post" action="{{route('create.adtype')}}"  style="margin-top:2%;" >
                        {{ csrf_field() }}
                        <div class="form-group" >
                            <label for="name control-label">Name</label>
                            <input type="text" class="form-control" id="adtypename" placeholder="Enter your ad type name" name="name">
