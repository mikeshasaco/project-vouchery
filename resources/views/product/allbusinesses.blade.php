                        ...
                        <div class="col-md-6 col-lg-4 col-12">
                            <div class="card"  id="cardproduct" data-product-id="{{ $product->id }}">
                                ...
                                <div class="card-body">
                                 ...
                                 <a href="{{ route('catBusinesses', $product->catslug) }}" class="nav-link" style=" color: #B35464;"> <small class="badges" style="position:absolute; left:13px; margin-top:-5px;">{{$product->category['categoryname']}}</small> </a>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card" id="cardproduct" data-product-id="{{ $product->id }}" >
                    ...
                    <div class="card-body">
                        ...
                        <p style="font-weight:bold; font-size:10px; opacity:0.8; margin:0;">
                        <i class="far fa-clock"></i> {{ Carbon\Carbon::parse($product->expired_date)->format('F d, Y') }} </p>
                        <a  href="{{ route('catBusinesses', $product->catslug) }}" class="nav-link" style=" color: #B35464; "> <small class="badges" style="position:absolute; left:13px; margin-top:-5px;">{{$product->categoryname}}</small> </a>
