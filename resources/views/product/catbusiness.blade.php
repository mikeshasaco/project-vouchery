...
<section id="catbusysection" style="margin-bottom:90px;" >
                                ...
                                <div class="card"  id="cardproduct" data-product-id="{{ $product->id }}">
                                    <div class="card-header">
                                        <ul class="nav nav-tabs card-header-tabs">
                                            <li>
                                                <a href="{{ url('/account' .'/'. $product->user['slug']) }}" class="nav-link" style="color:red;"> <small class="badges"> {{$product->company}}</small></a>
                                            </li>
   ...
   <section style="margin-top:10%; margin-bottom: 4%;" >
    ...
    $("[name='record']").on("change", function (e) {
        let slug = $(this).val();
        window.location.href = window.location.origin + '/businesses'+'/'+ slug;
    });
    </script>
