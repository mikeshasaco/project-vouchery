...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    @foreach( $submission as $photo )
       ...
       <a href="{{$photo->weblink}}" target="_blank"> <img  src="https://vouch.sfo2.digitaloceanspaces.com/home/forge/default/storage/app/public/Banner/{{$photo->image}}" width="100%;" height="280px;" >
       </a>
